-- ============================================================
-- СНАЧАЛА НАШ СКРИПТ, ПОТОМ ХАБ
-- Хаб загружается с задержкой, чтобы не блокировать выполнение.
-- ============================================================

-- Запускаем основной скрипт немедленно
...
if not success then
    warn("[AutoFarm] Ошибка:", err)
end

-- Загружаем хаб асинхронно с задержкой 5 секунд, чтобы наш скрипт уже стартовал
