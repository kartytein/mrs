-- ============================================================
-- Вставка текста (через SendTextInput) + активация кнопки
...
-- 3. Ввод текста через VirtualInputManager (реальная имитация)
if VIM and VIM.SendTextInput then
    VIM:SendTextInput(TEXT)
    task.wait(0.1)
else
    -- запасной вариант
    textBox.Text = TEXT
end
print("Текст введён:", TEXT)

-- 4. Снять фокус
textBox:ReleaseFocus()
task.wait(0.3)

-- 5. Найти и активировать опцию 3
